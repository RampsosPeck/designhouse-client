                    ...
                    <div class="filters d-flex justify-content-between align-items-center">
                        <ul class="filters-dropdown">
                            <li class="dropdown">
                                <select
									...
									@change="search"
                                >
                                    <option value="latest">Último primero </option>
                                    <option value="likes">Lo que más le gusta primero</option>
                                </select>
                            </li>
                        </ul>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="custom-control mr-3 custom-checkbox">
                                ...
                                <label class="custom-control-label"   for="hasComments">Tiene comentarios</label>
                            </div>
                            ...
                            <div class="custom-control custom-checkbox mr-3">
                                ...
                                <label class="custom-control-label"   for="hasTeam">Por equipo</label>
                            </div>
